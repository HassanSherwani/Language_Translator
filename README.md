...
The objective is to convert an English sentence to its German counterpart using a Neural Machine Translation (NMT) system. This assignment applies traditional language model , sequence to sequence model, and attention model for NMT.
...
- Seq2seq using neural net:(paper)Sutskever, I., Vinyals, O., & Le, Q. V. (2014). Sequence to sequence learning with neural networks. In Advances in neural information processing systems (pp. 3104-3112).
...
- Translation example(Eng-French): https://medium.com/@dev.elect.iitd/neural-machine-translation-using-word-level-seq2seq-model-47538cba8cd7

- Attention model code: https://medium.com/datalogue/attention-in-keras-1892773a4f22

- Attention-model concept in paper: Vaswani, A., Shazeer, N., Parmar, N., Uszkoreit, J., Jones, L., Gomez, A. N., ... & Polosukhin, I. (2017). Attention is all you need. In Advances in neural information processing systems (pp. 5998-6008).
